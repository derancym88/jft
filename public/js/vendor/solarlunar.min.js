/*!
 * solarlunar v3.1.0 - 阳历阴历（公历农历）互转
 * https://github.com/yize/solarlunar
 * Copyright (c) 2015, yize -- ISC License (see solarlunar.LICENSE.txt)
 * Vendored as-is (unmodified) for offline/no-build use in this PWA.
 */
